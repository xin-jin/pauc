...
This is a C++ implementation of a hybrid (with both Gauss-Seidel and Jacobi components) parallel auction algorithm. [[http://stanford.edu/~rezab/dao/projects_reports/jin.pdf][Click here for the report of the project]].
